...
public class  Bank{
	...
	public Bank(){
		...
		try (BufferedReader accNumReader = new BufferedReader(new FileReader("C:\\Users\\abc\\Desktop\\data\\prakhar data\\Banky project\\Banky Banking System\\src\\banky\\accNumSeq.txt"))){
